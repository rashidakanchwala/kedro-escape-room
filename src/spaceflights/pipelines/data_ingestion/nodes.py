...
def silent_node():
    ...
    """
    key = os.getenv("SILENCE_KEY")
    if not key:
        raise ValueError("The music is not in the notes, but in the silence between.")

    expected = "06fca49e873e311ce7dac2de09b1f01193b94248daff30b9ca7a1ef7c6dfc471"

    if hashlib.sha256(key.encode()).hexdigest() != expected:
        raise ValueError("The music is not in the notes, but in the silence between.")

    log.info("✅ Silence accepted. You may proceed.")
    return "Silence accepted. You may proceed."